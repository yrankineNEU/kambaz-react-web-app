  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-d-tag">
        <h4>Div Tags</h4>
        <p id="wd-p-1">
          Another commonly used HTML element is the div tag (division tag),
          which is a generic container used to group other elements together.
          Unlike heading tags, which have specific visual and semantic purposes,
          div tags do not inherently carry any meaning or formatting. They serve
          as a way to organize content on the page, often making it easier to
          apply styles or layout rules using CSS. For example, you can use a to
          div tag to group a heading, a paragraph, and an image together as a
          single unit within a webpage.
        </p>
      </div>
      <div id="wd-p-tag">
        <h4>Paragraph Tag</h4>
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Add 1 cup of dry rice to bowl</li>
          <li>Wash starch from rice by rinsing with water in sink</li>
          <li>Add washed rice to rice cooker and add water</li>
          <li>Start rice cooker</li>
          <li>Serve and enjoy once timer beeps!</li>
        </ol>
      ...
      Please
      <a
        href="https://github.com/yrankineNEU/kambaz-react-web-app.git"
        id="wd-github"
      >
        click here
      </a>
      to access GitHub code repository.
    </div>
  );
}
